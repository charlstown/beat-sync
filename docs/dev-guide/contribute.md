...
This guide will help you to contribute in different ways to Beat Sync.
...
Go to the [pull request section](https://github.com/charlstown/beat-sync/pulls) in the repository and select the `New pull request` button.
